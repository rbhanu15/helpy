    ...
    const windowHeight = Dimensions.get('window').height;
        ...
        return (
            <View style={styles.Container}>
               ...
               <Image source={gif} style={{height:windowWidth, width:windowHeight/2, justifyContent:'center', alignSelf:'center'}} />
                    <Text style={{fontSize:45, fontWeight:'bold',color:'black', alignSelf:'center'}}>{Together}</Text>
                    <Text style={{fontSize:25 ,marginHorizontal:20,marginTop:10, color:'black', letterSpacing:1,alignSelf:'center'}}>{Fight}
                    </Text>
