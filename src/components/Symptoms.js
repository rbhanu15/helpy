                ...
                <Card elevation={20} cornerRadius={19} style={{ padding: 30, margin: 20, marginBottom: 0 }}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                        <View style={{ borderRadius:19,padding: 20, margin: 10, width: 150, height: 150, backgroundColor: "#2F2E41" }}>
                            <Text style={{ paddingTop: 30, paddingBottom: 30, fontSize: 16, textAlign: 'center', fontWeight: "bold", color: 'white' }}>{Shortness}</Text>
                        </View>
                        <View style={{ borderRadius:19, padding: 20, margin: 10, width: 150, height: 150, backgroundColor: "#FFFF6F" }}>
                            <Text style={{ paddingTop: 30, paddingBottom: 30, fontSize: 20, textAlign: 'center', fontWeight: "bold" }}>{Dificultiy}</Text>
                        </View>
                    </View>
                    ...
                    <Text style={{ fontSize: 15, textAlign: 'center', fontWeight: "bold", color: 'white' }} onPress={() => Linking.openURL('https://www.who.int/emergencies/diseases/novel-coronavirus-2019')}>{who}</Text>
                    </View>
                </Card>     
